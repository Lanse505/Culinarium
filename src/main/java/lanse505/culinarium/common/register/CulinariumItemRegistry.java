...
public class CulinariumItemRegistry {
  ...
  public static final RegistryObject<ItemNameBlockItem> RYE_SEEDS = ITEMS.register("rye_seeds", () -> new ItemNameBlockItem(CulinariumBlockRegistry.RYE.get(), new Item.Properties()));
  ...
  public static final RegistryObject<HandSieve> HAND_SIEVE = ITEMS.register("hand_sieve", () -> new HandSieve(new Item.Properties()));
