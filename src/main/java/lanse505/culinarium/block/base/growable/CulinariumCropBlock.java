package lanse505.culinarium.block.base.growable;
...
public class CulinariumCropBlock extends CulinariumBushBlock implements BonemealableBlock {
  ...
  public CulinariumCropBlock(Properties pProperties) {
    super(pProperties);
    this.maxAge = 7;
  }

  public CulinariumCropBlock(Properties pProperties, int maxAge) {
    super(pProperties);
    this.maxAge = maxAge;
  }
